...
\end{lem}
\begin{proof}
In the same way as Proposition \ref{thm:embedding}, it suffices to show that the matrix $G_{\ve}+\gamma u^{-1}$ satisfies the reflection equation \eqref{eq:reflectG} which it is known in \cite{Arnaudon2004general,Ragoucy2007analytical,Belliard2009nested}.
\end{proof}
