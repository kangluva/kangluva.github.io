...
\vskip.15in
\noindent\textbf{Office Hours:} Wednesdays 2:00 -- 3:00PM and Thursdays 12:30 -- 1:30PM, or by appointment. My office is located at \underline{Kerchof Hall 229}.
...
There will be homeworks from WebAssign and written homeworks. The \textbf{class key} for signing up WebAssign will be given at the beginning of the semester. The written Homeworks are subset of problems from WebAssign which should be submitted to GradeScope. Typically, there will be 3 problems for every week. Two lowest written homeworks will be dropped for final grade.

There will be 12 quizzes in total that will be given in class and discussion session. The precise dates for quizzes can be found on Canvas. Two lowest quizzes will be dropped for final grade.
